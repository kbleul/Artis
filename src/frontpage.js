...
function ViewImg() {
    ...
    return (<>
        ...
        {showcomments ? <CommentsSection commentFunction={setshowcomments}/> : <SuggestionImgs artobject={art} commentFunction={setshowcomments}/>}
        </section>
    </>);
}

function CommentsSection(prop) {
    return(<div style={commentcancle_containerstyle}> 
        <p style={commentcancle_parastyle}>Comments</p>
    <button style={canclecomment_style} onClick={() => { prop.commentFunction(false)}}>
    <svg xmlns="http://www.w3.org/2000/svg" width="2.3em" height="2.3em" viewBox="0 0 16 16"><g fill="currentColor">
...
function SuggestionImgs(prop) {
    return (<>
        ...
        <div style={likebtn_container}>
            <button style={likebutton_style} onClick
                ...
                <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path d="M15 8C8.925 8 4 12.925 4 19c0 11 13 21 20 23.326C31 40 44 30 44 19c0-6.075-4.925-11-11-11c-3.72 0-7.01 1.847-9 4.674A10.987 10.987 0 0 0 15 8z" fill={prop.artobject.likestatus[0]} stroke="#000" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" /></svg>
            </button>
            <p style={likecountpar_style}>{prop.artobject.likestatus[3]}</p>
        </div>
    </div>
...
const arts = {
    ...
    img3: { account: "Mikel Gold", title: "City Life Algarve,Portugal 1977", artist: "Nikoal Mulion", price: "1100$ ", img: img3, boxstatus: [], likestatus: ["white", "", "", 1910], comments: { Natan: "wow !", NUNNNNNNNNN: "perfect" }, commentsSize: 2 },
    img4: {
    ...
    img5: { account: "Anchelote--", title: "The Particle Dao", artist: "Mitsu Aminkio", price: "266$ ", img: img5, boxstatus: [], likestatus: ["white", "", "", 244], commentsSize: 0 },
    img6: { account: "Pochetinio Polu", title: "Waves of Hope", artist: "Humer Zimmermam", price: "499$ ", img: img6, boxstatus: [], likestatus: ["white", "", "", 3601], commentsSize: 0 },
}
