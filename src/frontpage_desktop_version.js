...
function ImageList() {
    ...
    arts.img7.boxstatus = [imgone_boxstatus, set_imgone_boxstatus];
    arts.img8.boxstatus = [imgtwo_boxstatus, set_imgtwo_boxstatus];
    arts.img9.boxstatus = [imgthree_boxstatus, set_imgthree_boxstatus];
    arts.img10.boxstatus = [imgfour_boxstatus, set_imgfour_boxstatus];
    arts.img11.boxstatus = [imgfive_boxstatus, set_imgfive_boxstatus];
    arts.img12.boxstatus = [imgsix_boxstatus, set_imgsix_boxstatus];

    arts.img13.boxstatus = [imgone_boxstatus, set_imgone_boxstatus];
    arts.img14.boxstatus = [imgtwo_boxstatus, set_imgtwo_boxstatus];
    arts.img15.boxstatus = [imgthree_boxstatus, set_imgthree_boxstatus];
    arts.img16.boxstatus = [imgfour_boxstatus, set_imgfour_boxstatus];
    arts.img17.boxstatus = [imgfive_boxstatus, set_imgfive_boxstatus];
    arts.img18.boxstatus = [imgsix_boxstatus, set_imgsix_boxstatus];

    arts.img19.boxstatus = [imgone_boxstatus, set_imgone_boxstatus];
    arts.img20.boxstatus = [imgtwo_boxstatus, set_imgtwo_boxstatus];
    arts.img21.boxstatus = [imgthree_boxstatus, set_imgthree_boxstatus];
    arts.img22.boxstatus = [imgfour_boxstatus, set_imgfour_boxstatus];
